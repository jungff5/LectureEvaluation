...
%>
		...
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left"><%= evaluation.getLectureName() %>nbsp;<small><%= evaluation.getProfessorName() %></small></div>
		...
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left">알고리즘&nbsp;<small>배지웅</small></div>
				<div class="col-4 text-right">
		...
		<div class="card-body">
			...
			<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운건 없는것 같습니다</p>
			<div class="row">
				<div class="col-9 text-left">
		...
		<div class="card-header bg-light">
			<div class="row">
				<div class="col-8 text-left">자바&nbsp;<small>이고잉</small></div>
				<div class="col-4 text-right">
					종합<span style="color: red;">A</span>
				</div>
			</div>
